/* build: `node build.js modules=ALL exclude=gestures` */ /*! Fabric.js Copyright 2008-2013, Printio (Juriy Zaytsev, Maxim Chernyak) */ var fabric = fabric || {
    version: "1.2.0"
};
...
function () {
    ...
    function n(e, t) {
        ...
        var n = e.length - 1,
            r = t ? e[n][t] : e[n];
        if (t) while (n--) e[n][t] >= r && (r = e[n][t]);
        else while (n--) e[n] >= r && (r = e[n]);
        return r
    }
    function r(e, t) {
        if (!e || e.length === 0) return undefined;
...
function () {
    function e(e, t) {
        ...
        for (var r in t) if (r === "opacity") s(e, t[r]);
        else {
...
function () {
    ...
    initialize: function (e) {
        e || (e = {});
        if (e.source) if (typeof e.source == "string") if (typeof fabric.util.getFunctionBody(e.source) != "undefined") this.source = new Function(fabric.util.getFunctionBody(e.source));
        else {
            var t = this;
...
function () {
    ...
    var l = {
        ...
        drawControls: function (e) {
            ...
            else for (var n = 0, r = this._objects.length; n < r; ++n) {
...
function () {
    ...
    _enlivenDatalessObjects: function (e, t) {
        ...
        function o(e, t) {
            ...
            else if (e.type === "text") if (e.useNative) s(fabric.Text.fromObject(e), t);
            else {
                e.path = r;
...
function (e) {
    ...
    t.Object = t.util.createClass({
        ...
        set: function (e, t) {
            if (typeof e == "object") for (var n in e) this._set(n, e[n]);
        ...
        _parsePath: function () {
            ...
            for (var a = 0, f, l = this.path.length; a < l; a++) {
                ...
                var p = f[0].toLowerCase(),
                    d = t[p];
                if (f.length - 1 > d) for (var v = 1, m = f.length; v < m; v += d) e.push([f[0]].concat(f.slice(v, v + d)));
                else e.push(f)
            }
            return e
        },
